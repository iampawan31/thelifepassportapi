<header id="masthead" class="site-header clearfix">
    <h1 class="site-title">
        <a href="{{ route('dashboard') }}"><img src="{{ asset('images/logo.png') }}" alt="The Life Passport - Logo"
                class="img-fluid" /></a>
    </h1>
            ...
            <li>
                <div class="item professional-providers">
                    <span>
                        ...
                        </svg>{{ __('Professional Service Providers') }}
                    </span>
                    <div class="locked">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <div class="item real-estate">
                    <span>
                        ...
                        </svg>{{ __('Real Estate & Other Assets') }}
                    </span>
                    <div class="locked">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <div class="item physical-locations">
                    <span>
                        ...
                        </svg>{{ __('Physical Locations of Documents') }}
                    </span>
