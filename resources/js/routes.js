...
export const routes = [
    ...
    {
        path: "/spouse-estate-representative",
        component: PartnerEstateRepresentative
    },
    ...
    {
        path: "/estate-representative-question",
        component: EstateRepresentativeQuestion
    },
    {
        path: "/spouse-estate-representative-question",
        component: PartnerEstateRepresentativeQuestion
    },
    { path: "/belong-question", component: BelongQuestion },
    {
        path: "/computer-passwords-question",
        component: ComputerPasswordsQuestion
    },
    {
        path: "/medical-providers-question",
        component: MedicalProvidersQuestion
    },
